		...
		<header class="header">
			<nav class="navbar navbar-expand navbar-dark header-navbar">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown ml-3">
						<a class="nav-link dropdown-toggle no-arrow d-inline-flex align-items-center px-4" style="background-color: rgba(255,255,255,.1);" href="<?= base_url('logout') ?>">
			...
			<nav class="header-nav" id="header-nav">
				<ul class="nav header-menu position-static">
					...
					<li class="nav-item "><a class="header-menu-toggle dropdown-toggle no-arrow" href="<?= base_url('users') ?>">All Users</a>
					</li>
					<li class="nav-item "><a class="header-menu-toggle dropdown-toggle no-arrow" href="<?= base_url('voucher') ?>">Generate Voucher</a>
					</li>
